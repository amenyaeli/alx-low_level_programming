...
/**
 * check_elf - A function that hecks if a file is an ELF file.
 * @e_ident: An array of a pointer containing the ELF magic nos.
 *
...
/**
 * print_magic - A functin that prints the magic nos of an ELF header.
 * @e_ident: An array of a pointer containing the ELF magic nos.
 *
 ...
 * @e_ident: An array of a pointer  containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: An array of a pointer containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: Am array of a pointer containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: An array of a pointer containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_entry - A funct that rints the entry point of an ELF header.
...
/**
 * main -A func that displays the info contained in the
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	reads = read(m, header, sizeof(Elf64_Ehdr));
	if (reads == -1)
	{
		free(header);
		close_elf(m);
